...
def train(annotation_data, image_features,word_to_index_list, index_to_word_list, bias_init_vector,number_of_epochs,
    batch_size,dim_word_embedding,dim_context,dim_hidden,context_shape_start, context_shape_end, learning_rate, X_val=None, y_val=None, pretrained_model_path=None):
...
if __name__ == "__main__":
    ...
    y_val = config.get(file_paths, 'y_val_path')
    X_val = config.get(file_paths, 'X_val_path')
